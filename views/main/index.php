            ...
            <div class="about-info">
              <figure class="about-me">
                <figcaption>
                  ...
                  <h2>Profesionales</h2>
                  <p>
                    En <b>Veterinaria Puno</b>, estamos comprometidos con la salud y el bienestar de cada una de las
                    mascotas que forman parte de tu familia. Nuestro equipo de veterinarios y personal especializado
                    brinda atencion medica de alta calidad con un enfoque humano y cariñoso, creando un entorno seguro y
                    amigable para tus compañeros.
                    Queremos ser el centro veterinario de referencia en la región, donde cada familia confíe en nuestros
                    servicios para el cuidado y la salud de sus mascotas. Aspiramos a fortalecer la relación entre
                    humanos y animales, promoviendo el respeto y el cariño hacia todos los seres vivos.
                  </p>
                </figcaption>
              </figure>
            ...
            <div class="about-info">
              <figure class="about-me">
                <figcaption>
                  ...
                  <h2>Valores</h2>
                  <p>
                    <b>Compromiso:</b> Nos dedicamos plenamente a la salud de tu mascota, con ética y responsabilidad.
                    <br>
                    <b>Calidad:</b> Ofrecemos servicios veterinarios basados en la medicina moderna y el conocimiento
                    actualizado. <br>
                    <b>Cuidado:</b> Tratamos a cada mascota con respeto y compasión, valorando su bienestar y felicidad.
                    <br>
                    <b>Confianza:</b> Construimos relaciones duraderas con nuestros clientes a través de un servicio
    ...
    <div class="modal" id="modal">
      ...
      <div class="modal-content">
        <form action="" id="form-reservar" class="">
          ...
          <div class="datos-cita formulario" id="datos-cita">
            <label for="" class="item">Fecha</label>
            <input type="date" id="fecha" name="fecha" class="item" readonly>
            <label for="" class="item">Hora:</label>
            <select name="hora" id="hora" class="item">
            ...
            <label for="dni" class="item">DNI: </label>
            <input type="text" id="dni" name="dni" minlength="8" maxlength="8" class="item">
            <label for="" class="item">Nombre</label>
            <input type="text" id="nombre" name="nombre" class="item" readonly>
            <label for="" class="item">Apellido</label>
            <input type="text" id="apellido" name="apellido" class="item" readonly>
            <label for="" class="item">Telefono</label>
            <input type="text" id="telefono" name="telefono" minlength="9" maxlength="9" class="item">
            <label for="" class="item">Nombre de Mascota</label>
            <input type="text" id="mascota" name="mascota" class="item">
            <label for="" class="item">Especio</label>
            <!-- <input type="text" id="especie" name="especie"> -->
            <select name="especie" id="especie" class="item"></select>
            <label for="" class="item">Raza</label>
            <!-- <input type="text" id="raza" name="raza"> -->
            <select name="raza" id="raza" class="item"></select>
          </div>
          <div class="buttons">
            <button class="btn-reserva" type="submit" id="enviar">RESERVAR</button>
            <button class="btn-reserva" type="button" id="siguiente">SIGUIENTE</button>
